...
SECRET_KEY = 'django-insecure-jmya!#j#pi_&3v+3cmjhstj4^l_!3@t8^m#s$h8&wlx4v@i+5c'
...
# Define the STATICFILES_DIRS to include the location of your static files.
STATICFILES_DIRS = [
    os.path.join(f'{BASE_DIR}/shop', 'static')]
...
SIMPLE_JWT = {"ACCESS_TOKEN_LIFETIME": timedelta(days=30), "REFRESH_TOKEN_LIFETIME": timedelta(days=30),
              ...
              "ALGORITHM": "HS256", "SIGNING_KEY": SECRET_KEY, "VERIFYING_KEY": "", "AUDIENCE": None,
              "ISSUER": None, "JSON_ENCODER": None, "JWK_URL": None, "LEEWAY": 0,
