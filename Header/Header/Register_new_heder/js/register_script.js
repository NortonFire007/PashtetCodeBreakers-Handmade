...
function togglePasswordVisibility(pasw) {
    ...
    if (passwordInput.type === "password") {
        ...
        toggleButton.innerHTML = '<img src="img/loginout/open-eye.svg" alt="">'; // Изменение HTML содержимого кнопки для показа пароля
    } else {
        passwordInput.type = "password";
        toggleButton.innerHTML = '<img src="img/loginout/close-eye.svg" alt="">'; // Изменение HTML содержимого кнопки для скрытия пароля
    }
}
