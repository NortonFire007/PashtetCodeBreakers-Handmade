document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        ...
        document.getElementById('passwordError').textContent = 'Пароль повинен містити мінімум 8 символів, хоча б одну велику літеру і хоча б одну цифру';
        return;
        }
        else {
        ...
        document.getElementById('generalError').textContent = 'Будь ласка, заповніть усі обов\'язкові поля.';
        return;
        }
        else {
        ...
        .then(data => {
            ...
            console.error("Неможливо отримати access_token.");
            }
        })
        .catch(error => {
